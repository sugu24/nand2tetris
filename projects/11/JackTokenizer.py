class JackTokenizer:
    ...
    def advance(self):
        ...
        while len(self.jack_commands) > 0:
            ...
            # keyword
            if self.focus_token in self.keyword_set and (len(self.jack_commands) == 0 or ord(self.jack_commands[0]) == 10 or ord(self.jack_commands[0]) == 32):
                return
